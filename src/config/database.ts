...
module.exports = {
  local: {
    username: process.env.LOC_DB_USERNAME || '213067_cesar',
    password: process.env.LOC_DB_PASSWORD || '@488Gtb0',
    database: process.env.LOC_DB_NAME || 'cesarpea15_rootstack',
    host: process.env.LOC_DB_HOSTNAME || 'mysql-cesarpea15.alwaysdata.net',
  ...
  test: {
    ...
    port: process.env.CI_DB_PORT || 33060
  },
  production: {
